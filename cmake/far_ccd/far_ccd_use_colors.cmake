...
if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
  ...
  set(FAR_CCD_GLOBAL_FLAGS
      -fdiagnostics-color=always # GCC
      -fcolor-diagnostics # Clang
  )
  far_ccd_filter_flags(FAR_CCD_GLOBAL_FLAGS)
  message(STATUS "Adding global flags: ${FAR_CCD_GLOBAL_FLAGS}")
  add_compile_options(${FAR_CCD_GLOBAL_FLAGS})
endif()
