...
if(TARGET far_ccd::warnings)
  return()
endif()

set(FAR_CCD_WARNING_FLAGS
  -Wall
  -Wextra
  -pedantic
...
add_library(far_ccd_warnings INTERFACE)
add_library(far_ccd::warnings ALIAS far_ccd_warnings)

include(far_ccd_filter_flags)
far_ccd_filter_flags(FAR_CCD_WARNING_FLAGS)
target_compile_options(far_ccd_warnings INTERFACE ${FAR_CCD_WARNING_FLAGS})